...
object LocalNoteLibrary {
    ...
    fun scanAndImportLinkedFolder(context: Context, treeUri: Uri): LibraryFolderScanSummary {
        ...
        val found = mutableListOf<FolderNoteDocument>()
        ...
        found.forEach { doc ->
            runCatching {
                ...
                val changedSource = previousBySource != null && previousBySource.sha256 != sha
                ...
                upsertImportedNote(
                    ...
                    sourceSizeBytes = doc.sizeBytes ?: bytes.size.toLong(),
                    sourceLastModifiedMillis = doc.lastModifiedMillis,
                    cacheStatus = if (changedSource) "source hash changed" else "linked folder"
                )
                imported += 1
    ...
    private fun walkTree(
        ...
        notes: MutableList<FolderNoteDocument>,
        ...
        runCatching {
            context.contentResolver.query(childrenUri, projection, null, null, null)?.use { cursor ->
                ...
                while (cursor.moveToNext()) {
                    ...
                    } else if (name.endsWith(".note", ignoreCase = true)) {
...
private data class FolderNoteDocument(
